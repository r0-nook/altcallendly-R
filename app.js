...
// const r_TakeBack0=()=> {
//   let r_contentSave0 = {
//     r_box1Col1Img: document.getElementById('r_box1Col1Img').innerHTML,
...
// const r_TakeBack1=()=> {
//   let r_contentSave1 = {
//     r_box1Col2Img: document.getElementById('r_box1Col2Img').innerHTML,
//     r_box1Col2H3: document.getElementById('r_box1Col2H3').innerHTML,
//     r_box1Col2Time: document.getElementById('r_box1Col2Time').innerHTML,
//     r_box1Col2Location: document.getElementById('r_box1Col2Location').innerHTML,
//     r_box1Col2About: document.getElementById('r_box1Col2About').innerHTML
//   };
//   document.getElementById('r_box2Img').innerHTML = r_contentSave1.r_box1Col2Img;
//   document.getElementById('r_box2H1').innerHTML = r_contentSave1.r_box1Col2H3;
//   document.getElementById('r_box2Time').innerHTML = r_contentSave1.r_box1Col2Time;
//   document.getElementById('r_box2Location').innerHTML = r_contentSave1.r_box1Col2Location;
//   document.getElementById('r_box2About').innerHTML = r_contentSave1.r_box1Col2About;
//   document.getElementById('r_block2Right')
//     .innerHTML = '<button id="r_block2RightCreate" onClick="r_CreateEvent()">Create</button>';
// }
// const r_TakeBack2=()=> {
//   let r_contentSave2 = {
//     r_box1Col3Img: document.getElementById('r_box1Col3Img').innerHTML,
//     r_box1Col3H3: document.getElementById('r_box1Col3H3').innerHTML,
//     r_box1Col3Time: document.getElementById('r_box1Col3Time').innerHTML,
//     r_box1Col3Location: document.getElementById('r_box1Col3Location').innerHTML,
//     r_box1Col3About: document.getElementById('r_box1Col3About').innerHTML
//   };
//   document.getElementById('r_box2Img').innerHTML = r_contentSave2.r_box1Col3Img;
//   document.getElementById('r_box2H1').innerHTML = r_contentSave2.r_box1Col3H3;
//   document.getElementById('r_box2Time').innerHTML = r_contentSave2.r_box1Col3Time;
//   document.getElementById('r_box2Location').innerHTML = r_contentSave2.r_box1Col3Location;
//   document.getElementById('r_box2About').innerHTML = r_contentSave2.r_box1Col3About;
//   document.getElementById('r_block2Right')
//     .innerHTML = '<button id="r_block2RightCreate" onClick="r_CreateEvent()">Create</button>';
// }
// const r_AddNewEvent=()=> {
//   document.getElementById('r_box2Img')
//     .innerHTML = '' ;
//   document.getElementById('r_box2H1')
//     .innerHTML = '';
//   document.getElementById('r_box2Time')
//     .innerHTML = '';
//   document.getElementById('r_box2Location')
//     .innerHTML = '';
//   document.getElementById('r_box2About')
//     .innerHTML = '';
//   document.getElementById('r_block2Right')
//     .innerHTML = '';
// }
...
const r_SaveNewEvent=()=>{
  ...
  <div class="r_boxCol">
    ...
    <div class="r_boxColHead">
      <img id="r_box1ColImg" src="pik-conf.png"/>
      <h3 id="r_box1ColH3">
        ${r_box2FormSave.H}
      </h3>
    </div>
    ...
    <a href="#r_block2" class="r_box1Btn" id="r_box1ColTimeBtn" onClick="r_TakeBack()">BOOK ></a>
  </div>
</div>
  `;
  // del
